...
TOOL_ROUTER: Dict[str, Handler] = {
    ...
    "create-voice-channel": handle_create_voice_channel,
    "create_forum_channel": handle_create_forum_channel,
    "create-forum-channel": handle_create_forum_channel,
    "delete_channel": handle_delete_channel,
    "update_text_channel": handle_update_text_channel,
    "update-text-channel": handle_update_text_channel,
    "update_voice_channel": handle_update_voice_channel,
    "update-voice-channel": handle_update_voice_channel,
    "update_forum_channel": handle_update_forum_channel,
    "update-forum-channel": handle_update_forum_channel,
